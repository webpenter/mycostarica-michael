...
<div class="wrap">
	...
	if ( isset( $placements ) && is_array( $placements ) && count( $placements ) ) :
		...
		<form method="POST" action="" id="advanced-ads-placements-form">
			...
			data-orderby="type" data-dir="asc">%1$s %2$s</a> / <a href="#" class="advads-sort ' . ( $orderby === 'name' ? 'advads-placement-sorted' : '' ) . '"
			data-orderby="name" data-dir="asc" style="margin-left:9px;">%3$s %2$s<a/></th>', esc_html( $order_type ), '<span class="advads-placement-sorting-indicator"></span>', esc_html( $name ) );
						else :
						...
						<td class="advads-placements-table-options">
							...
							<?php if ( $advanced_options ) : ?>
								<div class="advads-placements-show-options">
									<a href="#modal-<?php echo esc_attr( $_placement_slug ); ?>"
