...
jQuery(document).ready(function ($) {
    ...
    $(document).on('change','.gmb_url_shortener, .fb_url_shortener, .tw_url_shortener, .li_url_shortener, .tb_url_shortener, .dc_url_shortener, .ff_url_shortener, .ba_url_shortener, .ins_url_shortener, .pin_url_shortener, .yt_url_shortener, .wp_url_shortener, .rd_url_shortener, .tele_url_shortener,.md_url_shortener', function () {
    ...
    $(document).on('change', 'input[name="wpw_auto_poster_options[reddit_custom_msg_options]"],input[name="wpw_auto_poster_options[fb_custom_msg_options]"], input[name="wpw_auto_poster_options[li_custom_msg_options]"], input[name="wpw_auto_poster_options[ba_custom_msg_options]"], input[name="wpw_auto_poster_options[ins_custom_msg_options]"], input[name="wpw_auto_poster_options[pin_custom_msg_options]"], input[name="wpw_auto_poster_options[yt_custom_msg_options]"], input[name="wpw_auto_poster_options[wp_custom_msg_options]"], input[name="wpw_auto_poster_options[gmb_custom_msg_options]"], input[name="wpw_auto_poster_options[tele_custom_msg_options]"],input[name="wpw_auto_poster_options[medium_custom_msg_options]"]', 
        function(){
