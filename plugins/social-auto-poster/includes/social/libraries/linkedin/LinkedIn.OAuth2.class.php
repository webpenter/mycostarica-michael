...
class LinkedInOAuth2 extends OAuth2 {
	...
	public function getAdminCompanies() {
		...
		// $params['url']						= "https://api.linkedin.com/v2/organizationalEntityAcls?q=roleAssignee&role=ADMINISTRATOR&state=APPROVED";
		$params['url']						= "https://api.linkedin.com/v2/organizationalEntityAcls";
		$params['method']					= 'get';
		$params['args']['q'] = 'roleAssignee';
		$params['args']['role'] = 'ADMINISTRATOR';
		$params['args']['state'] = 'APPROVED';
		$params['args']['projection'] = '(elements*(organizationalTarget~(localizedName,name,id)))';
