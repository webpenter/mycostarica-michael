			...
			<div id="wordpress_general" class="postbox">	
				...
				<div class="inside">
					<table class="form-table"><tbody>
						<tr valign="top">
							<th scope="row">
								<label for="wpw_auto_poster_reposter_options[enable_telegram]"><?php esc_html_e( 'Repost to WordPress:', 'wpwautoposter' ); ?></label>
							</th>
							<td>
						...
						<tr valign="top">
							...
							<td class="wpw-auto-poster-select">
								...
								<select name="wpw_auto_poster_reposter_options[wp_post_type_cats][]" id="wpw_auto_poster_reposter_options[wp_post_type_cats]" class="wp_post_type_cats wpw-auto-poster-cats-tags-select" multiple="multiple">
									<?php
						...
						<tr valign="top">
							<th scope="row">
								<label><?php esc_html_e( 'Custom Content Option:', 'wpwautoposter' ); ?></label>
							</th>
							<td>
