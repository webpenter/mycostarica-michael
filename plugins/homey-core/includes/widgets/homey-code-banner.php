<?php
class homey_Code_Banner extends WP_Widget {
	...
	**/
	public function __construct() {
		...
		parent::__construct(
	 		'homey_code_banner', // Base ID
			esc_html__( 'Homey: Code Banner', 'homey' ), // Name
			array( 'description' => esc_html__( 'Paste your banner JS or Google Adsense code', 'homey' ), ) // Args
		);
		...
		echo wp_kses( $before_widget, $allowed_html_array );
			...
			echo '<div class="widget-body">';
				echo '<div class="module-body">';
					echo '<div class="homey_code_banner">';
	...
	**/
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'banner_code' ) ); ?>"><?php esc_html_e('JS or Google AdSense Code', 'homey'); ?></label>
...
if ( ! function_exists( 'homey_Code_Banner_loader' ) ) {
    function homey_Code_Banner_loader (){
     register_widget( 'homey_Code_Banner' );
    }
     add_action( 'widgets_init', 'homey_Code_Banner_loader' );
}