...
class WP3D_Models_Taxonomy {
	...
	public function register_taxonomy () {
        ...
        $labels = array(
            ...
            'all_items' => sprintf( __( 'All %s' , 'wp3d-models' ), $this->plural ),
            'edit_item' => sprintf( __( 'Edit %s' , 'wp3d-models' ), $this->single ),
            'view_item' => sprintf( __( 'View %s' , 'wp3d-models' ), $this->single ),
            'update_item' => sprintf( __( 'Update %s' , 'wp3d-models' ), $this->single ),
            'add_new_item' => sprintf( __( 'Add New %s' , 'wp3d-models' ), $this->single ),
            'new_item_name' => sprintf( __( 'New %s Name' , 'wp3d-models' ), $this->single ),
            'parent_item' => sprintf( __( 'Parent %s' , 'wp3d-models' ), $this->single ),
            'parent_item_colon' => sprintf( __( 'Parent %s:' , 'wp3d-models' ), $this->single ),
            'search_items' =>  sprintf( __( 'Search %s' , 'wp3d-models' ), $this->plural ),
            'popular_items' =>  sprintf( __( 'Popular %s' , 'wp3d-models' ), $this->plural ),
            'separate_items_with_commas' =>  sprintf( __( 'Separate %s with commas' , 'wp3d-models' ), $this->plural ),
            'add_or_remove_items' =>  sprintf( __( 'Add or remove %s' , 'wp3d-models' ), $this->plural ),
            'choose_from_most_used' =>  sprintf( __( 'Choose from the most used %s' , 'wp3d-models' ), $this->plural ),
