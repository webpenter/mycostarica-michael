...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Section Titles','homey').'</span>'), $allowed_html_array),
            'subtitle' => '',
            'desc'   => ''
        ),
        array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'        => array(
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( __('Follow','homey').' <a target="_blank" href="https://favethemes.zendesk.com/hc/en-us/articles/360045293072">'.__('WooCommerce Documentation','homey').'</a>', $allowed_html_array),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'        => array(
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Email header','homey').'</span>'), $allowed_html_array),
            'subtitle' => '',
            'desc'   => ''
        ),
        array(
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Email Footer','homey').'</span>'), $allowed_html_array),
            'subtitle' => '',
            'desc'   => ''
        ),
        array(
        ...
        array(
            ...
            'required' => array('enable_email_footer', '=', '1'),
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Social Link 1','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
        array(
        ...
        array(
            ...
            'style'  => 'info',
            'required' => array('enable_email_footer', '=', '1'),
            'title'  => wp_kses( ('<span class="font24">'.__('Social Link 2','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
        array(
            'id'       => 'social_2_icon',
        ...
        array(
            ...
            'style'  => 'info',
            'required' => array('enable_email_footer', '=', '1'),
            'title'  => wp_kses( ('<span class="font24">'.__('Social Link 3','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
        array(
            'id'       => 'social_3_icon',
        ...
        array(
            ...
            'style'  => 'info',
            'required' => array('enable_email_footer', '=', '1'),
            'title'  => wp_kses( ('<span class="font24">'.__('Social Link 4','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
        array(
            'id'       => 'social_4_icon',
...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('New Registered User Notification','homey').'</span>'), $allowed_html_array),
...
Homey Team.',
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('New Registered Admin Notification','homey').'</span>'), $allowed_html_array),
            'desc'   => esc_html__( '{user_login_register} as username, {user_password} as user password, {user_email_register} as new user email, {profile_url}', 'homey' )
        ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('New Reservation Received','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
...
<p><strong>Guest Message:</strong> {guest_message}&nbsp;<a href="{message_link}">click for reply</a><br /><br />Confirm Availability <a href="{reservation_detail_url}">Confirm</a><br /><br />Thank you for choosing Homey!<br />Homey Team.</p>',
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('New Reservation Sent','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
...
<p><strong>Your Message:</strong> {guest_message}&nbsp;<a href="{message_link}">click to send another message</a><br /><br /> for details <a href="{reservation_detail_url}">Click here</a><br /><br />Thank you for choosing Homey!<br />Homey Team.</p>',
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Confirm Reservation','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
...
Homey Team.',
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Reservation Booked User','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
...
Homey Team.',
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Reservation Booked Admin','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
...
Homey Team.',
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Reservation Declined','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
...
Homey Team.',
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Reservation Cancelled','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
...
Homey Team.',
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses(('<span class="font24">'.__('Local Payment Received','homey').'</span>'), $allowed_html_array),
            'desc'   => ''
        ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('New Submission of Listing','homey').'</span>'), $allowed_html_array),
...
Listing Status: {post_status_admin}',
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Update Submission of Listing','homey').'</span>'), $allowed_html_array),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Upgrade to Featured','homey').'</span>'), $allowed_html_array),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses(('<span class="font24">'.__('ID Verification Request','homey').'</span>'), $allowed_html_array),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Payout Request Admin','homey').'</span>'), $allowed_html_array),
...
<p>Follow this link for details: <a href="{payout_link}">{payout_link}</a></p>',
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Payout Request Host','homey').'</span>'), $allowed_html_array),
...
Your payout will be processed as part of our normal schedule. You will receive an email when your payout has been processed',
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Payout Completed','homey').'</span>'), $allowed_html_array),
...
Happy Spending!",
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses(('<span class="font24">'.__('Payout Cancelled','homey').'</span>'), $allowed_html_array),
...
Thank You",
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Payment Adjustment Add Money','homey').'</span>'), $allowed_html_array),
...
Thank You",
        ...
        array(
            ...
            'notice' => false,
            'style'  => 'info',
            'title'  => wp_kses( ('<span class="font24">'.__('Payment Adjustment Deduct Money','homey').'</span>'), $allowed_html_array),
            'subtitle' => esc_html__('you can use {username} as User Name, {amount} as Adjustment Amount, {reason} as Reason', 'homey'),
        ),
