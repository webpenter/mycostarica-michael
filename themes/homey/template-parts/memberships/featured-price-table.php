...
<div class="price-table-module featured">
    ...
    <div class="price-table-description">
        <ul class="list-unstyled">
            ...
            <li>
                <i class="fa fa-check" aria-hidden="true"></i> <?php esc_html_e('Listings', 'homey'); ?>: <strong><?php echo esc_attr($unlimited_listings) == 'on' ? esc_html__('Unlimited Listings', 'homey') : esc_attr($listings_included); ?></strong>
            </li>
            <li>
